...
///
/// Do not allocate the extra space for another array. You must do this by modifying the input
...
///   }
///
/// If all asserts pass, then your solution will be accepted.
///
/// Example 1:
///
///   Input: nums = [1,1,2]
///   Output: 2, nums = [1,2,_]
///   Explanation: Your function should return k = 2, witht the first two elements of nums being 1
///   and 2 respectively.
...
impl Solution {
    pub fn remove_duplicates(nums: &mut Vec<i32>) -> i32 {
        nums.iter().unique().count().try_into().unwrap()
    }
}
